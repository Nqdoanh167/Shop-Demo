...
export default function Buy1() {
    ...
    const infoUser = localStorage.hasOwnProperty('infoUser') ? JSON.parse(localStorage.getItem('infoUser')) : [];
    ...
    const handleClick = async () => {
        ...
        try {
            let data = await axios.post('https://data-bebasic.onrender.com/api/v1/create-bill', sum);
        ...
        <>
            <div className="bottomProductBuy">
                <div className="form-group">
                    ...
                    <select className="form-control" id="payment" onChange={(e) => handleOnchange(e)}>
                        <option value="0">Thanh toán khi nhận hàng</option>
                        <option value="1">Chuyển khoản ngay</option>
                    </select>
                    {methodPay === '1' ? (
                        <div style={{ padding: '10px' }}>
                            <p>Số tài khoản: 0912746230</p>
                            <p>Chủ tài khoản: Nguyễn Quốc Doanh</p>
                            <img
